...
`wiki` is a placeholder filled by `llm-wiki init` from the project's `kb.include` configuration. Replace it with the real content root when constructing actual proposal paths.
