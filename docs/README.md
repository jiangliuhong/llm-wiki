...
- [LLM Wiki Pi 集成设计（V2）](./pi-integration-v2.md)
  说明在不依赖 Pi Hub 产品和 UI 的前提下，借鉴其 Session 管理方式，将 Pi SDK、单 Agent Runtime、Tauri 可信边界、双向 Core Tool Bridge、会话数据和凭据管理集成到 LLM Wiki。
...
> `architecture-v1.md`、`cli-design-v1.md`、`pi-integration-v2.md` 与桌面端原型描述目标架构和后续迁移方案；CLI 使用指南与已知限制描述当前仓库已经实现的能力。二者不要混淆。Desktop Pi 集成细节以 `pi-integration-v2.md` 为准。
